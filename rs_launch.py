...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'json_file_path',               'default': "'/home/mason/laser_off.json'", 'description': 'allows advanced configuration'},
                           ...
                           {'name': 'rgb_camera.profile',           'default': '640,480,6', 'description': 'color image width'},
                           ...
                           {'name': 'infra1_fps',                   'default': '30', 'description': 'enable infra2 stream'},
                           {'name': 'infra2_fps',                   'default': '30', 'description': 'enable infra2 stream'},
                           {'name': 'color_fps',                    'default': '6', 'description': 'enable infra2 stream'},
                           {'name': 'depth_fps',                    'default': '6', 'description': 'enable infra2 stream'},
